          ...
          >
            ...
            >
              ...
              <div className="pt-[28px] pb-0 flex justify-center">
                <h2 className="text-[#1E293B] font-bold text-[24px] text-center leading-[28px]" style={{ fontFamily: 'Roboto', fontWeight: 700 }}>
                  Escolha Seu Plano
                </h2>
              </div>
              ...
              <div className="mx-auto w-[263px] h-[49px] border border-[#D9D9D9] rounded-[40px] flex relative mt-[19px] mb-0">
                <div
                  ...
                  className={`flex-1 h-[43px] rounded-[40px] flex items-center justify-center cursor-pointer transition-all duration-200 ${billingPeriod === 'mensal'
                      ? 'bg-gradient-to-r from-[#FD4B19] to-[#BBB736]'
                      : ''
                    }`}
                  style={{ margin: '3px 4px' }}
                >
                  <span className={`text-[16px] font-semibold leading-[19px] ${billingPeriod === 'mensal' ? 'text-white' : 'text-[#1E293B]'
                ...
                <div
                  ...
                  className={`flex-1 h-[43px] rounded-[40px] flex items-center justify-center cursor-pointer transition-all duration-200 ${billingPeriod === 'anual'
                      ? 'bg-gradient-to-r from-[#FD4B19] to-[#BBB736]'
                      : ''
                    }`}
                  style={{ margin: '3px 4px' }}
                >
                  <span className={`text-[16px] font-semibold leading-[19px] ${billingPeriod === 'anual' ? 'text-white' : 'text-[#1E293B]'
                    }`} style={{ fontFamily: 'Roboto Condensed' }}>
                    anual
                  </span>
                </div>
              ...
              >
                <div className="absolute left-[14px] top-[11px] flex items-center gap-[16px]">
                  <Image
                    ...
                    className="object-contain"
                  />
                  <p className="text-[#1E293B] font-bold text-[20px] leading-[27px]" style={{ fontFamily: 'Roboto', fontWeight: 700 }}>PRO</p>
                </div>
                <div className="absolute right-[16px] top-[11px] flex flex-col items-end">
                  <div className="flex items-baseline gap-[4px]">
                    <span className="text-[rgba(100,116,139,0.4)] font-semibold text-[11px] leading-[15px] line-through" style={{ fontFamily: 'Roboto' }}>147,90</span>
                    <p className="text-[#1E293B] font-semibold text-[16px] leading-[21px]" style={{ fontFamily: 'Roboto' }}>R$ 19,99</p>
                  </div>
                  <p className="text-[#1E293B] font-semibold text-[11px] leading-[15px] mt-[9px]" style={{ fontFamily: 'Roboto' }}>por mês</p>
                </div>
              </div>
              ...
              >
                <div className="absolute left-[14px] top-[11px] flex items-center gap-[12px]">
                  ...
                  <p className="text-[#1E293B] font-bold text-[20px] leading-[27px]" style={{ fontFamily: 'Roboto', fontWeight: 700 }}>Viajante</p>
                </div>
                <div className="absolute right-[16px] top-[11px] flex flex-col items-end">
                  <div className="flex items-baseline gap-[4px]">
                    <span className="text-[rgba(100,116,139,0.4)] font-semibold text-[11px] leading-[15px] line-through" style={{ fontFamily: 'Roboto' }}>230,90</span>
                    <p className="text-[#75738C] font-semibold text-[16px] leading-[21px]" style={{ fontFamily: 'Roboto' }}>R$ 49,90</p>
                  </div>
                  <p className="text-[#75738C] font-semibold text-[11px] leading-[15px] mt-[9px]" style={{ fontFamily: 'Roboto' }}>por mês</p>
                </div>
              </div>
