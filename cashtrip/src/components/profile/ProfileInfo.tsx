            ...
            <div className="bg-[var(--surface-card)] rounded-[20px] p-6 flex flex-col items-center shadow-sm border border-[var(--border-line)] dark:border-transparent mb-8">
                <div className="relative mb-4">
                    ...
                    <button
                        ...
                        className="absolute bottom-0 right-0 w-[32px] h-[32px] bg-[#FF5F38] rounded-full flex items-center justify-center border-[3px] border-white dark:border-[#1E293B] shadow-sm hover:bg-[#E64E28] transition-colors"
                    >
